...
test_X = np.load(shared_drive_path + 'logs/grid_method_params_combined_20.npy',allow_pickle=True).item()
test_Y_unlog = np.load(shared_drive_path + 'logs/grid_method_pk_combined_20.npy', allow_pickle=True)
reshaped_array = test_Y_unlog.reshape(-1, 2000)
...
save_path = 'grid_percentile_plot.png'
